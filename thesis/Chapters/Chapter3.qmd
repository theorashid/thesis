...
The deprivation data for geographies larger than LSOAs in @tbl-ch-3-geography were created by ranking the population-weighted average of scores for all constituent LSOAs, as done previously for districts [@EnglishIndicesDeprivation2019].
