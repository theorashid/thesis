...
| Geography | Number of units | Median (5$^{\text{th}}$-95$^{\text{th}}$ percentile) population in 2019 |
| --------- | --------------- | ------------------------------------------------ |
| region    | 9               | 5,934,037 (3,536,336-9,092,877)                  |
| district  | 314             | 140,271 (68,238-380,483)                         |
| MSOA      | 6791            | 7985 (5760–11,917)                               |
| LSOA      | 32,844          | 1620 (1235-2468)                                 |

: The numbers of each spatial unit of England used in the thesis and their populations in 2019. {#tbl-ch-3-geography}

England is divided into nine regions (North East, North West, Yorkshire and the Humber, East Midlands, West Midlands, East of England, South East, South West, London).
...
OAs, LSOAs, and MSOAs are all statistical units which are designed by the Office for National Statistics (ONS) purely for analysis purposes, so researchers can use spatial units with similar, but small, population sizes.
...
The data is extracted from the ONS database and held by SAHSU in a secure environment as individual death records are identifiable data.
...
The second data source we require are population counts.
...
Male mortality is higher at all ages, but particularly in young adulthood (15-29 years) due to injuries resulting from risky behaviours.
...
All-cause and cause-specific mortality estimates require data on deaths and populations.
Individual death records with information of sex, age at death, cause of death, year of death, and place of residence have been taken from the ONS database and held by SAHSU in a secure environment.
I have used small-area population estimates created by the ONS.
I also introduced datasets on area-level deprivation and migration which will be used to put mortality estimates into context.