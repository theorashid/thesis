...
In particular, I will focus on the spatial methods, which were developed at the unit and I build upon in the thesis, in the context of disease mapping studies of SAHSU.
...
A number of SAHSU studies have employed physics-informed models to create an exposure surface, and assessed the geographic correlations between this surface and the health outcome, notably for a plume of mercury pollution [@hodgsonAssessmentExposureMercury2007], exposure to mobile phone base stations during pregnancy [@elliottMobilePhoneBase2010], noise from aircraft near Heathrow [@hansellAircraftNoiseCardiovascular2013], road traffic noise in London [@halonenRoadTrafficNoise2015], and particulate matter from incinerators during pregnancy [@parkesRiskCongenitalAnomalies2020].
...
The cuts were geographically unequal, with reductions in funding for local governments particularly severe for local authorities with an old industrial base [@grayDepthsCutsUneven2018].
...
This presented a double challenge for governments in high-income countries as the demand for care only continued to rise due to growing and ageing populations, with higher proportions of the populations suffering ill-health and complex multi-morbidities [@hamRiseDeclineNHS2023].
...
And it is not just life expectancy: the UK has performed worse as measured by cancer survival rates and infant mortality compared to other industrialised countries [@oecdOECDReviewsHealth2016].
