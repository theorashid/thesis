...
The section begins with an overview of the spatial methods for mapping mortality for small areas and some examples of applications from the UK and beyond looking at mortality for small subnational regions.
...
@finucaneBayesianEstimationPopulationLevel2014 demonstrate how country-level blood pressure can be modelled by exploiting the hierarchy global, super-region, region and country.
...
This is because estimates of all-cause mortality are more robust, as the death counts are larger and therefore lower variance, and the data do not suffer from errors in assignment of cause of death.
