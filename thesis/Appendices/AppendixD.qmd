...
| Ovarian cancer                     | C56                                                    |
| Lymphoma and multiple myeloma      | C81-C90, C96                                           |
...
: Groups of causes of death used in the district-level cause-specific mortality analysis in @sec-Chapter7 with ICD-10 codes. {#tbl-ap-ch7-causes}
...
These were all neonatal deaths, which are not assigned an underlying cause of death, and were imputed using the code in the first position on the death record.
...
: Groups of causes of death used in the district-level cancer mortality analysis in @sec-Chapter8 with ICD-10 codes. {#tbl-ap-ch8-cancers}
